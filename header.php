                ...
                <nav class="navbar navbar-expand-lg py-0">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNavDropdown">
                        ...
                        <ul class="navbar-nav ms-auto navCustom">
                            <!-- "me-auto" for left align | "ms-auto" for right align | "mx-auto" for center align--->
                            <li class="nav-item">
                                <a class="nav-link" href="a-propos.php">Vendteskilos</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="comment-ca-marche.php">Comment ça marche</a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item dropdown me-3">
                                <a class="nav-link dropdown-toggle d-flex align-items-center" href="#" id="dropdownItem"
                                    ...
                                    <!-- <iconify-icon icon="bx:user" class="fs-3 me-1"></iconify-icon> -->
