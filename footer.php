        ...
        <div class="container">
            ...
            <div class="col-lg-3 d-flex align-items-center justify-content-center">
                ...
                <div class="col-lg-3">
                    ...
                    <p class="mb-2"><a href="politique-de-confidentialite.php" class="d-block link-theme"> Confidentialité &
                            Cookies </a></p>
                    <p class="mb-2"><a href="produits-interdits.php" class="d-block link-theme"> Produits interdits</a></p>
                </div>
            </div>
